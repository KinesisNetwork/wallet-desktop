import { LockAccount, TimeStamp, UnlockWallet, Wallet } from '@types'
...
export const unlockWalletSuccess = buildAction('UNLOCK_WALLET_SUCCESS').payload<UnlockWallet & LockAccount>()
export const unlockWalletFailure = buildAction('UNLOCK_WALLET_FAILURE').payload<TimeStamp>()
