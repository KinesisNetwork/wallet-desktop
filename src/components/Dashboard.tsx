...
export class Dashboard extends React.Component<{appState: AppState}, {account: any, kinesisBalance: number, accountActivated: boolean, targetAddress: string, transferAmount: number}> {
  constructor (props) {
    super(props)
